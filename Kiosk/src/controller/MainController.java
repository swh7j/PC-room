                    ...
                    public void run() {
                    	...
                    	for(Pc temp : pcactlist) {
    						...
    						if(temp.getP_activation()==1) {
    							pcbuttons[temp.getP_no()].setStyle("-fx-background-color: #66b2ff ; -fx-background-radius:15;\r\n"
