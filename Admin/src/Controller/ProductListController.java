      ...
      if (type == 0) {
         ...
         productlist.setOnMouseClicked(e -> {
            ...
            if (e.getButton().equals(MouseButton.PRIMARY)) {
               ...
               // 로고
               String path = "src/FXML/" + product.getP_img() + ".jpg";
               try {
...
//               pimg.setImage(image);
               ...
               lblpcount.setText("제품재고 : " + String.format("%,d", product.getP_count()) + " EA");
               lblpcategory.setText("제품분류 : " + product.getP_category());
               lblpdate.setText("등록일 : " + product.getP_date().split(" ")[0]);
               lblpprice.setText("제품가격 : " + String.format("%,d", product.getP_price()) + " 원");
         ...
         productlist.setOnMouseClicked(e -> {
            ...
            if (e.getButton().equals(MouseButton.PRIMARY)) {
               ...
               // 4. 선택된 객체내 이미지 경로 가져오기
               try {
                  FileInputStream input3 = new FileInputStream("src/FXML/" + product.getP_img() + ".jpg");
